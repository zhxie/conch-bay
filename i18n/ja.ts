...
const ja = {
  ...
  grizzco_blaster: "クマサン印のブラスター",
  grizzco_brella: "クマサン印のシェルター",
  grizzco_charger: "クマサン印のチャージャー",
  grizzco_slosher: "クマサン印のスロッシャー",
  grizzco_stringer: "クマサン印のストリンガー",
  grizzco_splatana: "クマサン印のストリンガー",
  // Brands.
  "QnJhbmQtMA==": "バトロイカ",
  "QnJhbmQtMQ==": "アイロニック",
  "QnJhbmQtMg==": "クラーゲス",
