...
const ja = {
  ...
  send_a_mail: "メールを送る",
  database_notice:
    "データベースをクリアして対応するデータをクリアできます。データベースをクリアしたい場合は、対応するボタンを長押ししてください。続行する前に、バックアップを完了してください！",
  clear_image_database: "画像データーベースを消去",
  clearing_image_database: "画像データーベースを消去中",
  clear_result_database: "リザルトデーターベースを消去",
  clearing_result_database: "リザルトデーターベースを消去中",
