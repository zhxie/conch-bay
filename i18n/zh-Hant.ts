const zhHant = {
  ...
  log_in: "登錄",
  log_in_notice:
    "法螺灣需要獲取令牌以訪問魷魚圈3。該過程涉及向非任天堂的imink發送含有最少的非身份資訊的安全請求，並且這些資訊不會被記錄或存儲。請參閱imink隱私政策以獲取更多資訊。",
  ...
  relog_in: "重新登錄",
  resource_notice:
    "如果法螺灣無法載入圖片，您可以提前進行預載入。請注意，由於魷魚圈3的限制，法螺灣僅能預載入部分圖片。",
  ...
  loading_n_new_results: "載入%{n}項新記錄中",
