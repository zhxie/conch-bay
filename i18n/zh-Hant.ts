...
const zhHant = {
  ...
  send_a_mail: "發送郵件",
  database_notice:
    "您可以清除資料庫以清除對應的資料。如果您想清除資料庫，請長按對應的按鍵。請在繼續之前完成備份！",
  clear_image_database: "清除圖像資料庫",
  clearing_image_database: "清除圖像資料庫中",
  clear_result_database: "清除記錄資料庫",
  clearing_result_database: "清除記錄資料庫中",
