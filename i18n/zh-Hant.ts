const zhHant = {
  ...
  log_in: "登錄",
  log_in_notice:
    "法螺灣需要獲取令牌以訪問魷魚圈3。該過程涉及向非任天堂的imink發送含有最少的非身份信息的安全請求，並且這些信息不會被記錄或存儲。請參閱imink隱私政策以獲取更多信息。",
  ...
  stats: "統計",
  stats_notice: "由當前已加載的記錄統計。",
  import: "導入",
  export: "導出",
  exporting: "導出中",
  disclaimer: "本應用是使用魷魚圈3的信息的非官方應用，與任天堂有限公司無關。",
  support: "支持",
  language_notice:
  ...
  relog_in: "重新登錄",
  resource_notice:
    "如果法螺灣無法載入圖片，您可以提前進行預加載。請注意，由於魷魚圈3的限制，法螺灣僅能預加載部分圖片。",
  preload_resources: "預加載資源",
  preloading_resources: "預加載資源中",
  feedback_notice: "如果您在使用法螺灣時遇到任何問題或有任何建議，請隨時分享您的反饋。",
  create_a_github_issue: "創建GitHub Issue",
  debug_notice: "以下信息僅用於調試。請不要與他人分享。",
  copy_session_token: "複製會話令牌",
  copy_bullet_token: "複製Bullet令牌",
  export_database: "導出數據庫",
  privacy_policy: "隱私政策",
  acknowledgments: "致謝",
  creators: "創作者",
  license: "許可",
  first_aid_notice: "數據庫已損壞並無法加載。請導出記錄並重新安裝法螺灣。",
  failed_to_check_api_update: "未能檢查API更新",
  reacquiring_tokens: "重新獲取令牌中",
  loading_n_new_results: "加載%{n}項新記錄中",
  loading_n_results: "加載%{n}項記錄中",
  loaded_n_results: "已加載%{n}項記錄",
  loaded_n_results_fail_failed: "已加載%{n}項記錄，%{fail}項失敗",
  loaded_n_results_fail_failed_skip_skipped: "已加載%{n}項記錄，%{fail}項失敗，%{skip}項跳過",
