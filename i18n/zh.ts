const zh = {
  ...
  log_in: "登录",
  log_in_notice:
    "法螺湾需要获取令牌以访问鱿鱼圈3。该过程涉及向非任天堂的imink发送含有最少的非身份信息的安全请求，并且这些信息不会被记录或存储。请参阅imink隐私政策以获取更多信息。",
