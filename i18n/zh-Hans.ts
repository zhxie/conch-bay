...
const zhHans = {
  ...
  log_in_notice:
    "您可以在不登录的情况下使用法螺湾查看日程与鱿鱼须商城，导入记录并通过统计与趋势分析。登录将允许您加载记录与好友，查看装备以及访问鱿鱼圈3。登录需要向任天堂以外的imink或nxapi发送非识别信息，这些信息不会被记录或存储，请参阅隐私政策以获取更多信息。",
  ...
  n_filtered_results_showed: "已显示%{n}/%{filtered} (%{total})项筛选的记录",
  today: "今日",
  this_week: "本周",
  this_month: "本月",
  this_season: "本赛季",
