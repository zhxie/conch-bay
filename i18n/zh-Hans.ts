...
const zhHans = {
  ...
  send_a_mail: "发送邮件",
  database_notice:
    "您可以清除数据库以清除对应的数据。如果您想清除数据库，请长按对应的按键。请在继续之前完成备份！",
  clear_image_database: "清除图像数据库",
  clearing_image_database: "清除图像数据库中",
  clear_result_database: "清除记录数据库",
  clearing_result_database: "清除记录数据库中",
