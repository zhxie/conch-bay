...
const en = {
  ...
  database_notice:
    "You can clear the database to clear the corresponding data. If you want to clear the database, please long press on the corresponding button. Please complete a backup before proceeding!",
  clear_image_database: "Clear Image Database",
  clearing_image_database: "Clearing Image Database",
  clear_result_database: "Clear Result Database",
  clearing_result_database: "Clearing Result Database",
