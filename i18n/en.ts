...
const en = {
  ...
  log_in: "Log In",
  log_in_notice:
    "You can use Conch Bay to view schedules, import results, and analyze stats and trends without logging in. Logging in will allow you to load results and friends, view gears, and access SplatNet 3. Logging in involves sending non-identifying information to non-Nintendo nxapi. This information will not be logged or stored, please see the privacy policy for more information.",
  log_in_warning:
